## AI
execute if entity @a[distance=..24,gamemode=!creative,gamemode=!spectator] run scoreboard players add @s voyager.entity_1 1
execute unless entity @a[distance=..24,gamemode=!creative,gamemode=!spectator] run scoreboard players reset @s voyager.entity_1
