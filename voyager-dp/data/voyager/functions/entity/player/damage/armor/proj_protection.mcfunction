...
execute store result score #helm voyager.damage run data get storage voyager.damage:temp self.Inventory[{Slot:103b}].tag.Enchantments[{id:"minecraft:projectile_protection"}].lvl
execute store result score #chest voyager.damage run data get storage voyager.damage:temp self.Inventory[{Slot:102b}].tag.Enchantments[{id:"minecraft:projectile_protection"}].lvl
execute store result score #legs voyager.damage run data get storage voyager.damage:temp self.Inventory[{Slot:101b}].tag.Enchantments[{id:"minecraft:projectile_protection"}].lvl
execute store result score #boots voyager.damage run data get storage voyager.damage:temp self.Inventory[{Slot:100b}].tag.Enchantments[{id:"minecraft:projectile_protection"}].lvl
